 ...
 * Package: org.example.transport.netty.codec
 * Description:
...
public class RpcMessageDecoder extends LengthFieldBasedFrameDecoder {
     ...
     * @param lengthAdjustment    要添加到长度字段值上的补偿值
     * @param initialBytesToStrip 跳过的字节数。如果需要接收所有的头部+正文数据，该值为0.如果您只想接收正文数据，那么需要跳过头部消耗的字节数。
     */
